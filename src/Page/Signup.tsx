...
export default function Signup() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // After form submission, redirect to Hero page
    navigate('/hero'); // Make sure you have this route set up
  };
      ...
      <div className={`fixed inset-0 w-full h-full transform transition-all duration-500 ease-in-out ${
        ...
        <div className="absolute inset-0 -z-10">
          <img
            ...
            className="w-full h-full object-center object-fill" // Changed to object-cover for better responsiveness
          /> 
        </div>
